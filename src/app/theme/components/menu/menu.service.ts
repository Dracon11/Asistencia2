...
export class MenuService {
  ...
  public createVerticalMenuItem(menu: Array<Menu>, menuItem) {
    ...
    this.renderer2.setAttribute(
      link,
      'data-original-title',
      this.localLang !== null ? menuItem.title[this.localLang] : menuItem.title['es']
    );
    ...
    const menuText = this.renderer2.createText(this.localLang !== null ? menuItem.title[this.localLang] : menuItem.title['es']);
